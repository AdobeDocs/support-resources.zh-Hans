---
title: 技术用户画像的主要功能
description: /[!DNL Adobe Success/] 门户为技术用户画像提供的功能，使用户能够创建和管理支持案例、监控系统性能，并跟踪与安全性和功能相关的警报。
...
[!DNL Adobe Success] 门户为技术用户画像提供的视图旨在帮助用户创建工单、管理支持案例和监控系统性能。 以下是门户为这类用户提供的主要功能。
