---
user-guide-title: Adobe支持和工具指南
user-guide-description: 有关Adobe支持和工具的详细指导和更新。
...
- Experience League支持门户 — 新用户界面 {#exl-new-ui}
  - [概述](/help/adobe-support-tools-guide/exl-new-ui-overview.md)
  - [创建和管理支持案例](/help/adobe-support-tools-guide/exl-new-ui-support-cases.md)
- [Adobe支持语音助手 — 非工作时间和周末支持（日本）](/help/adobe-support-tools-guide/adobe-support-voice-assistant.md)
- Adobe Admin Console {#adobe-admin-console}
  ...
  - [管理员角色](adobe-admin-console/admin-roles.md)
  ...
  - [在Global Admin Console中选择组织](adobe-admin-console/select-an-organization-in-the-global-admin-console.md)
  - [管理管理员](adobe-admin-console/manage-administrators.md)
  - [在Global Admin Console中管理产品配置文件](adobe-admin-console/manage-product-profiles.md)
  - [在Global Admin Console中更新组织策略](adobe-admin-console/update-policies.md)
  ...
  - [设置身份和单点登录](adobe-admin-console/adobe-set-up-identity-and-sso.md)
  ...
  - [将Frame.io用户管理迁移到Admin Console](adobe-admin-console/migrate-user-management-to-the-adobe-admin-console.md)
...
- Adobe Commerce支持 {#adobe-commerce-support}
  ...
  - [适用于Adobe Commerce的Experience League支持用户指南](adobe-commerce-support/adobe-commerce-help-center-user-guide.md)
  ...
  - [如何应用Adobe提供的独立修补程序](adobe-commerce-support/how-to-apply-an-isolated-security-patch-file-provided-by-adobe.md)
  - [支持工具概述](adobe-commerce-support/overview.md)
