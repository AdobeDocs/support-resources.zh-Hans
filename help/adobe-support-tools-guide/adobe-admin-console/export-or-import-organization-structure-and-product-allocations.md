...
访问&#x200B;**[!UICONTROL Global Admin Console]**&#x200B;中的[组织](https://helpx.adobe.com/enterprise/global-admin-console/adopt-global-administration.html)选项卡以导出或导入组织结构。 转到&#x200B;**[!UICONTROL 产品分配]**&#x200B;选项卡以查看分配数据。 选择&#x200B;**[!UICONTROL 更多选项]** (⋮)图标，然后选择&#x200B;**[!UICONTROL 导出]**&#x200B;或&#x200B;**[!UICONTROL 导入]**。
