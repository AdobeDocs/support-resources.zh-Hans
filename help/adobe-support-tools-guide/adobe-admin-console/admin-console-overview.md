...
Adobe Admin Console是一个中央位置，用于管理整个组织的Adobe授权。 您可以使用它来管理您的许可证、用户和付款。 转到此处[登录到Admin Console](https://adminconsole.adobe.com)。 若要了解详细信息，请参阅以下[视频](https://helpx.adobe.com/cn/enterprise/using/admin-console.html)。
