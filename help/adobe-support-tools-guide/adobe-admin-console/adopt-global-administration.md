...
[Global Admin Console](https://global-admin-console.adobe.com)适用于具有复杂组织结构的客户，这些客户可能拥有多个Admin Console或希望将其主Admin Console拆分为多个控制台。 例如，跨国公司、教育联合会、大型学区和大型政府机构。 它将现有的Admin Console嵌套到一个层次结构中（如组织结构图），以在分布式企业中提供透明度。
...
要了解有关Global Admin Console的功能和优势的更多信息，请参阅Global Admin Console[上的](https://community.adobe.com/questions-624/new-white-paper-for-the-adobe-global-admin-console-678929#M35625)白皮书并观看以下[视频](https://youtu.be/FLBWR78wpok)。
