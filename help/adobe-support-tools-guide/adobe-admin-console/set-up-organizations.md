...
组织是一种用于管理Adobe产品和用户的结构。 通过[Adobe Admin Console](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/admin-console-overview)，管理员可以管理其组织中产品和用户的部署和配置。 [Global Admin Console](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/adopt-global-administration)允许全局管理员创建、管理和删除多个组织。
