...
- 系统管理员列表（由创建&#x200B;**[策略](https://helpx.adobe.com/enterprise/global-admin-console/update-policies.html)时继承系统管理员的**&#x200B;控制）。
以下内容可能会阻止系统管理员被继承：
...
了解有关产品分配[&#128279;](https://helpx.adobe.com/enterprise/global-admin-console/allocate-products.html#limitations)的限制的更多信息。
