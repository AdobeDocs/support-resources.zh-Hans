...
5. 选择&#x200B;**[!UICONTROL 审阅挂起的更改]**&#x200B;以审阅更新。 然后，选择&#x200B;**[!UICONTROL 提交更改]**&#x200B;以[执行更改](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/execute-jobs)。
...
8. 选择&#x200B;**[!UICONTROL 审阅挂起的更改]**&#x200B;以审阅更新。 然后，选择&#x200B;**[!UICONTROL 提交更改]**&#x200B;以[执行更改](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/execute-jobs)。
...
7. 选择&#x200B;**[!UICONTROL 审阅挂起的更改]**&#x200B;以审阅更新。 然后，选择&#x200B;**[!UICONTROL 提交更改]**&#x200B;以[执行更改](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/execute-jobs)。
...
4. 选择&#x200B;**[!UICONTROL 审阅挂起的更改]**&#x200B;以审阅更新。 然后，选择&#x200B;**[!UICONTROL 提交更改]**&#x200B;以[执行更改](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/execute-jobs)。
...
4. 编辑组织后，选择&#x200B;**[!UICONTROL 审阅挂起的更改]**&#x200B;以审阅这些更改。 然后，选择&#x200B;**[!UICONTROL 提交更改]**&#x200B;以[执行更改](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/execute-jobs)。
