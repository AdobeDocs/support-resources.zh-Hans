...
在[Global Admin Console](https://helpx.adobe.com/enterprise/global-admin-console/adopt-global-administration.html)中，转到&#x200B;**[!UICONTROL 产品分配]**&#x200B;选项卡，然后选择要分配给子组织的产品。
...
Global Admin Console中的&#x200B;**[!UICONTROL 产品分配]**&#x200B;选项卡显示跨组织层次结构购买的产品分配单位。 作为[全局管理员](https://helpx.adobe.com/enterprise/global-admin-console/manage-administrators.html#admins)，您可以将这些产品资源分配给组织树中的其他组织，并指定要分配的数量。 作为[全局查看器](https://helpx.adobe.com/enterprise/global-admin-console/manage-administrators.html#admins)，您可以查看和导出数据，但无法进行任何更新。
...
作为[全局管理员](https://helpx.adobe.com/enterprise/global-admin-console/manage-administrators.html#admins)，您可以允许过度分配资源。
