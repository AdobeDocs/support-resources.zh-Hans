...
系统分析会在整个案例创建工作流中显示。 输入问题详细信息后，**[!UICONTROL 系统分析]**&#x200B;面板将显示在屏幕右侧，即AI支持的推荐部分的上方。 要了解有关AI支持的推荐的更多信息，请参阅Adobe客户支持体验一文中的[填写支持工单](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-customer-support-experience#fill-out-the-support-ticket)。
