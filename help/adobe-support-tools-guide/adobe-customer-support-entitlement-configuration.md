...
有关更多详细信息，请参阅管理角色文档中的[编辑企业管理员角色](adobe-admin-console/admin-roles.md#edit-enterprise-admin-role)说明。 请注意，只有组织的系统管理员才能分配此角色。 有关管理层次结构的详细信息，请访问[管理角色](adobe-admin-console/admin-roles.md)文档。
