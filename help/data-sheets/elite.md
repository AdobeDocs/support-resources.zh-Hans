---
title: 精英支持
description: Adobe Experience Cloud精英支持服务提供一流的服务级别目标(SLT)、主动预防性支持，并与技术客户经理和指定支持工程师合作。
...
Adobe Experience Cloud精英支持服务提供一流的服务级别目标(SLT)、主动预防性支持，并与技术客户经理和指定支持工程师合作。
...
| 优先级 | 在线支持 | 精英支持 |
|--- |--- |--- |
| <b>优先级1</b><br>客户的生产业务功能已停机或出现重大数据丢失或服务降级，需要立即注意恢复功能和可用性。 | 24x7/<br>1小时 | 24x7/<br>15分钟 |
| <b>优先级2</b><br>客户的业务功能会导致重大服务降级或潜在数据丢失，或主要功能受到影响。 | 工作时间/<br>4小时 | 24x5/<br>30分钟 |
| <b>优先级3</b><br>客户的业务功能会轻微甚至没有服务降级，但存在允许业务功能正常继续的解决方案/解决方法。 | 工作时间/<br>6小时 | 24x5/<br> 1小时 |
...
<tr>
  <td>
    ...
    <div>
    <p><b>技术客户经理</b></p>
    <p>指定的技术客户经理负责监督您的精英经验，协调支持和现场服务工作，并提供主动预防性服务以最大限度地实现您的业务价值。</p>
    </div>
  </td>
  <td>
    <img alt="指定支持工程师" src="assets/namedsupportengineer.png"/>
    <div>
    <p><b>指定支持工程师</b></p>
    <p>熟悉您的解决方案环境和业务目标的指定支持工程师。 NSE是一位经验丰富的支持工程师，可帮助协调您的精英支持体验。</p>
    </div>
  </td>
  <td>
    ...
    <div>
    <p><b>案例审查</b></p>
    <p>定期审查开放支持请求，确保客户在案例描述、业务影响、状态、优先级和就确保权宜解决所需的后续步骤达成一致。</p>
    </div>
  </td>
</tr>
<tr>
  <td>
    <img alt="呈报管理" src="assets/EscalationManagement.png"/>
    <div>
    <p><b>呈报管理</b></p>
  ...
  <td>
    <img alt="服务审阅" src="assets/ServiceReviews.png"/>
    <div>
    <p><b>服务审阅</b></p>
    <p>定期审查Elite计划服务、支持指标和交付内容，包括前瞻性的交付计划。</p>
    </div>
  </td>
  <td>
    <img alt="专家会议" src="assets/expertsessions.png"/>
    <div>
    <p><b>专家会议</b></p>
    <p>60分钟的会议，重点讨论特定产品功能以及如何利用它解决常见业务问题。</p>
    </div>
  </td>
</tr>
<tr>
  ...
  <td>
    ...
    <div>
    <p><b>解决方案路线图审查</b></p>
    <p>比较Adobe解决方案路线图并将其与您的项目路线图保持一致，以降低风险并为未来做好准备。</p>
    </div>
  </td>
  <td>
    ...
    <div>
    <p><b>维护和监控</b></p>
    <p>接收维护最佳实践和最新修复（SP、MR、补丁、FP），以保持所有维护检查的最新状态</p>
    </div>
  </td>
</tr>
<tr>
  <td>
    <img alt="发行准备和审阅" src="assets/releasepreview.png"/>
    <div>
    <p><b>发行准备和审阅</b></p>
    <p>获得关于新产品功能的个性化指导以利用最新的创新，并让Adobe专家审查发布和升级计划。</p>
    </div>
  </td>
  <td>
    <img alt="知识传递" src="assets/KnowledgeTransfer.png"/>
    <div>
    <p><b>知识传递</b></p>
    <p>Adobe支持团队不断传递知识，以提供有关解决方案使用的最佳实践。</p>
    </div>
  </td>
  <td>
    ...
    <div>
    <p><b>事件管理</b></p>
    <p>管理关键事件，以确保在这些关键业务和项目里程碑期间制定适当的支持、覆盖和缓解计划级别。</p>
    </div>
  </td>
</tr>
</table>
...
<tr>
  <td>
    <div>
    <p><b>AEM as aCloud Service的管理</b></p>
    <p>技术和运营治理，以协助AEM as a Cloud Service客户遵守AEM as a Cloud Service的行业标准和最佳实践。</p>
    </div>
  </td>
  <td>
    <div>
    <p><b>AEM as a Service的增值服务Cloud Service</b></p>
    <p>确定、审核并提供有关具有优化机会的自定义解决方案采用领域的建议。</p>
    </div>
  </td>
  <td>
    <div>
    <p><b>AEM as a Cloud Service的自定义最佳实践</b></p>
    <p>在AEM as a Cloud Service中推动采用自定义最佳实践和核心组件。</p>
    </div>
  </td>
</tr>
</table>
...
对于实施&#x200B;**新Adobe Experience Cloud解决方案**&#x200B;的客户，Launch建议是一组&#x200B;*核心咨询服务*&#x200B;和建议，这些建议经证实可支持成功的部署并加快实现价值的时间。

<!--
![Support implementation and operation](assets/support-implementation.png)
-->

Adobe解决方案专家通过基于最佳实践的指导，帮助验证要求、架构、开发流程和启动就绪性审查，以便向客户和实施合作伙伴提供指导。

Launch建议将通过常见的里程碑（启动、定义、设计、上线和发布后）与您的项目计划保持一致，以指导、验证、评估和提出建议。 主要交付项包括：
...
Field Services用于&#x200B;**快速解决方案**、集中客户成功和加速&#x200B;**时间值**。 如果Launch建议处于活动状态，则对于Adobe支持合同涵盖的任何解决方案产品，第1年&#x200B;**中将没有任何现场服务。**

作为Elite客户，您有资格从以下两个跟踪中每年&#x200B;**4次活动**:**Technical**&#x200B;和/或&#x200B;**Strategic**。

**技术跟踪活** 动可确保客户在技术上保持稳健，并最大限度地采用其工具。具体而言，这些类型的活动包括与平台配置、集成和疑难解答相关的支持和建议。
...
**战略跟** 踪活动寻找机会，以确保从客户的Adobe解决方案中实现价值。它们包括与战略、测量和成熟度相关的支持建议，以推动在一个或多个Adobe解决方案中实现价值。
