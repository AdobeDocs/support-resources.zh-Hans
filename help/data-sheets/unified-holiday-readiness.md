...
* [AEP蓝图：护栏](https://experienceleague.adobe.com/en/docs/blueprints-learn/architecture/architecture-overview/guardrails)
...
遵循[计划和透视：2025年高峰季战略方针](https://experienceleague.adobe.com/en/perspectives/planning-and-pivoting-a-strategic-approach-to-peak-season-2025)指南中的建议，该指南使用Adobe Commerce（和可选的Adobe Experience Cloud工具）提供切实可行的战略，帮助您规划、透视并在一年中最繁忙的时间提供卓越的客户体验。
...
* [2025年第一季度发行版概述](https://experienceleague.adobe.com/en/docs/workfront/using/product-announcements/product-releases/release-25-q1/25-q1-release-overview)
