...
本文档概述了AdobeDX支持案例生命周期的改进，旨在增加沟通并尽快为客户提供解决方案，以帮助确保客户取得成功。 以下是支持过程中遇到的各种情景的时间表和通知：

**案例跟进提醒**

| 通知 | 案例状态 | 通知计时 | 到结案状态的天数 |
|--- |--- |--- |--- |
| **第1** | 提供了待处理响应或解决方案 | 24小时/ 1天 | 5 天 |
| **2nd** | 已提供待处理响应或解决方案 | 72小时/ 3天 | 3 天 |
| **第3** | 提供了待处理响应或解决方案 | 120小时/ 5天 | 1 天 |
...
* 在状态被设置为“已提供解决方案”之后的第1、3和5天，会向客户发送后续通知，请求确认所提供的解决方案。
