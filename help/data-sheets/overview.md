...
Adobe成功计划超越了被动式问题解决方案，为您带来全新的个性化体验，让您的业务步骤领先于任何问题。 您的Adobe团队拥有深厚的技术专业知识、多样化的能力以及先进的方法，可为您提供所需的适当级别的支持、专业知识以及技术和战略指导。

## 专家成功计划与最终成功计划的比较

|  | 专家成功计划 | 最终成功计划 |
|--- |--- |--- |
|  | 通过专家成功计划，您可以 **全天候专家服务** ，以获得有关您的关键业务问题的技术故障排除和指导。 或者，您可以通过我们的自助资源、独家最佳实践以及 Adobe 专家和同行的网络社区找到快速解决方案。 <p> *所有 Adobe Experience Cloud 许可证都附带该计划。* | 有了最终成功计划，您将体验 **提供战略指导和积极的技术储备，以提供高性能数字体验**. 您的Adobe环境将由一个熟悉您的业务并专注于执行与您的目标和优先事项相一致的路线图以实现业务影响的专家团队提供支持。 |
| **成功团队** | 汇集了支持工程师团队 | 包括： <ul><li> 指定的技术客户经理 </li><li> 指定的客户成功经理 </li><li> 指定的支持服务经理</li><li> 由技术工程师和战略专家组成的联合团队提供“成功加速器” </li><li> 汇集了支持工程师团队 </li></ul> |
| **主动的技术和运营支持** | ![不包括图标](assets/Cross_red_circle.svg){width="20"}不包括 | 包括： <ul><li>升级和迁移审查、发布准备 </li><li>产品路线图审查</li><li> 统一的技术和战略路线图</li><li>关键活动的准备和规划</li><li>规划相关和及时的启用</li><li>技术最佳实践和行业指导</li><li>提倡/调整产品团队</li><li>实现关键业务目标的统一计划 — 共同行动计划(MAP)</li></ul> |
| **技术支持** | 包括： <ul><li>**P1**：全天候问题支持</li><li>**P2、P3、P4**：工作时间支持</li><li>标准停机管理</li><li>共用的上报管理</li></ul> | 包括： <ul><li>**P1**：全天候问题支持</li><li>**P2/P3**：全天候问题支持</li><li>**P4**：工作时间支持</li><li>优先停机管理</li><li>指定的专家上报管理</li></ul> |
| **成功加速器** | ![不包括图标](assets/Cross_red_circle.svg){width="20"}不包括 | TAM和CSM定期计划的成功加速器<p>*（有关更多信息，请参阅成功加速器目录）* |
